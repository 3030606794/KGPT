...
import tn.eluea.kgpt.core.ui.dialog.box.ChooseRoleDialogBox;
import tn.eluea.kgpt.core.ui.dialog.box.ChooseSubModelDialogBox;
...
import tn.eluea.kgpt.core.ui.dialog.box.ChatInputDialogBox;
    ...
    private DialogBox buildBox(DialogType dialogType) {
        ...
        switch (dialogType) {
            ...
            case WebSearch:
                ...
                break;
            case ChooseRole:
                box = new ChooseRoleDialogBox(this, mParent, mInputBundle, mConfig);
                break;
            case ChooseSubModel:
                box = new ChooseSubModelDialogBox(this, mParent, mInputBundle, mConfig);
                break;
            case ChatInput:
                box = new ChatInputDialogBox(this, mParent, mInputBundle, mConfig);
                break;
            case OtherSettings:
