...
public class LabActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        // Floating Ball entrance
        View fbCard = findViewById(R.id.card_floating_ball);
        if (fbCard != null) {
            fbCard.setOnClickListener(v -> {
                startActivity(new Intent(this, FloatingBallActivity.class));
            });
        }
    }
