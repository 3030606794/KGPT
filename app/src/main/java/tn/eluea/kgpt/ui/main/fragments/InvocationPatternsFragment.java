...
public class InvocationPatternsFragment extends Fragment {
    ...
    private void showEditPatternDialog(ParsePattern pattern, int position) {
        ...
        etSymbol.setSelection(currentSymbol.length());
        ...
        switchEnabled.setOnCheckedChangeListener((buttonView, isChecked) -> {
            ...
            Toast.makeText(requireContext(),
                    getString(isChecked ? R.string.msg_trigger_enabled : R.string.msg_trigger_disabled, updated.getType().title),
        ...
        btnReset.setOnClickListener(v -> {
            ...
            etSymbol.setSelection(defaultSymbol.length());
        });
        ...
        btnSave.setOnClickListener(v -> {
            ...
            updated.setEnabled(pattern.isEnabled());
